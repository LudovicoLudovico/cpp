...
double norm(Complex &c) { return (c.real() * c.real() + c.imag() * c.imag()); }
...
int main() {
  ...
  if (selection < 4) {
    ...
    std::cout << "Reale: " << result.real() << " Imag: " << result.imag()
              << std::endl;
    return 0;
  }
  ...
  if (selection == 6) {
    ...
    std::cout << "Real: " << sols.first().real()
              << " Imag: " << sols.first().imag() << "i\n";
    std::cout << "Real: " << sols.second().real()
              << " Imag: " << sols.second().imag() << "i\n";
  }
