...
std::vector<double> calculate_a_b(std::vector<double> &x, std::vector<double> &y, double sigma_y)
{
    double sum_x;
    ...
    a = (sum_x_squared * sum_y - sum_x * sum_x_y) / (x.size() * sum_x_squared - (sum_x * sum_x));
    b = (x.size() * sum_x_y - sum_x * sum_y) / (x.size() * sum_x_squared - (sum_x * sum_x));

    double sigma_a = sigma_y * sqrt(sum_x_squared / (x.size() * sum_x_squared - (sum_x * sum_x)));
    double sigma_b = sigma_y * sqrt(x.size() / (x.size() * sum_x_squared - (sum_x * sum_x)));
